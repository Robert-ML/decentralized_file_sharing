...
class ShareRequestsServicer:
    ...
    async def __forever_listen_to_requests(self) -> None:
        logging.info("Starting forever listen to share requests")
    ...
    async def __forever_send_share_request_responses(self) -> None:
        ...
        logging.info(f"Starting forever send share request responses")
        while CommonVars().running:
            try:
                ...
                logging.error(f"Forever send share request responses gave error: {repr(e)}", exc_info=e)
